...
class TwitterAccount:
    ...
    def performTweetAnalytics(self):
        ...
        try:
            averageCharactersPerTweet = averageCharactersPerTweet / numberOfTweets
        ...
        #print("averageCharacterPerTweet: ",averageCharactersPerTweet)
        #print("averageWordsPerTweet: ",averageWordsPerTweet)
        #print("averageLikesPerTweet: ",averageLikesPerTweet)
        # averageCharactersPerTweet,averageWordsPerTweet,averageLikesPerTweet
        return [averageCharactersPerTweet,averageWordsPerTweet,averageLikesPerTweet]
    ...
    def getAnalyticsAsHTML(self):
        ...
        html += f"<div><hr />"
        html += f"<p>averageCharacterPerTweet: {statData[0]}</p>"
        html += f"<p>averageWordsPerTweet: {statData[1]}</p>"
        html += f"<p>averageLikesPerTweet: {statData[2]}</p>"
        html += f"<p>please keep going...</p>"
        html += f"</div>"
        return html
...
class TweetAnalyzer(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setWindowTitle('Tweet Seeker Analytics 1.2')
