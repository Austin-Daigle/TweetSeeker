...
#   TWITTER API SECRETS
############################################################################
apiKey = "ADD_YOUR_API_HERE"
apiSecretKey = "ADD_YOUR_API_SECRET_KEY_HERE"
bearer_token = "ADD_YOUR_BEARER_TOKEN_HERE"
accessToken = "ADD_YOUR_ACCESS_TOKEN_HERE"
accessToken_secret = "ADD_YOUR_TOKEN_SECRET_HERE"
#***************************************************************************
...
############################################################################
    # try to scrap the twitter account, if the account is not available/valid
    # thrown an error
    try:
        userAccountInput = input("Please Enter A Twitter Account Name: ")
        print("You entered: ", userAccountInput)
        sampleAccount = TwitterAccount(userAccountInput)
        print(sampleAccount)
    except Exception as e:
        print("Twitter Search Failure", 
            f"Twitter API Error!\nReason(s):\n{e}")
